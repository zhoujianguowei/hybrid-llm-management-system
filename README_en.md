...
- [🔌 llama.cpp Parameters Reference](docs/llama-cpp-parameters.md)
...
> 📖 Full parameter tables (startup args with ranges/defaults, speculative-decoding syntax, thinking-mode mapping, GGUF quantization) live in [docs/llama-cpp-parameters.md](docs/llama-cpp-parameters.md).
